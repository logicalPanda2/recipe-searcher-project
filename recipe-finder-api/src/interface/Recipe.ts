...
export function isRecipe(value: unknown): value is Recipe {
	if (
		...
		typeof (value as Record<string, unknown>).strInstructions ===
			"string" &&
		...
		typeof (value as Record<string, unknown>).strIngredient10 ===
			"string" &&
		"strIngredient11" in value &&
		typeof (value as Record<string, unknown>).strIngredient11 ===
			"string" &&
		"strIngredient12" in value &&
		typeof (value as Record<string, unknown>).strIngredient12 ===
			"string" &&
		"strIngredient13" in value &&
		typeof (value as Record<string, unknown>).strIngredient13 ===
			"string" &&
		"strIngredient14" in value &&
		typeof (value as Record<string, unknown>).strIngredient14 ===
			"string" &&
		"strIngredient15" in value &&
		typeof (value as Record<string, unknown>).strIngredient15 ===
			"string" &&
		"strIngredient16" in value &&
		typeof (value as Record<string, unknown>).strIngredient16 ===
			"string" &&
		"strIngredient17" in value &&
		typeof (value as Record<string, unknown>).strIngredient17 ===
			"string" &&
		"strIngredient18" in value &&
		typeof (value as Record<string, unknown>).strIngredient18 ===
			"string" &&
		"strIngredient19" in value &&
		typeof (value as Record<string, unknown>).strIngredient19 ===
			"string" &&
		"strIngredient20" in value &&
		typeof (value as Record<string, unknown>).strIngredient20 ===
			"string" &&
